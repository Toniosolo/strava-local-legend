"""
STRAVA Local Legend Dashboard - Authentication par token direct
===============================================================
Chaque utilisateur colle son propre Access Token Strava.
Plus de limite de quota OAuth !
"""
...
def api_segments():
    ...
    segments_csv     = load_json(segs_cache_path)
    ...
    for sid_str, seg in segment_efforts.items():
        if sid_str in all_segments_map:
            all_segments_map[sid_str]["my_efforts"] = seg["my_efforts"]
...
if __name__ == "__main__":
    print("\n  Strava Local Legend Dashboard (token direct)")
